...
function exibirMensagemInicial() {
    ...
    exibirTextoNaTela('p', 'Choice a number between 1 and 10');
}
...
function verificarChute() {
    ...
    if (chute == numeroSecreto){
        ...
        if (chute > numeroSecreto){
            ...
            exibirTextoNaTela('p','The secret number is smaller than the guess!');
        } else {
            exibirTextoNaTela('h1','You made a mistake!');
            exibirTextoNaTela('p','The secret number is greater than the guess!');
        } 
        tentativas++;
        limparCampo();
    }
